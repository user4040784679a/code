...
class AE:
    def build_full_ae(self, trainable=True):
        ...
        print('Pree')
        print(self.Decoder_3D[-1].output)
        ...
        self.part_label_pred = tf.argmax(tf.squeeze(tf.nn.softmax(self.part_label)), 2)
        ...
        with tf.name_scope('Optimizer'):
            ...
            self.loss_labels = utils.mse(tf.squeeze(self.input_labels.output), tf.squeeze(self.part_label))
