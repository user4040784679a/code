...
import provider
import sys
import tf_ops.modi_distance20.tf_nndistance as tfnndis
import json
import h5py
...
class AE:
    def build_full_ae(self, trainable=True):
        ...
        with tf.name_scope('Optimizer'):
            # 3D Optimizer
            reta,retb,retc,retd = tfnndis.nn_distance(tf.squeeze(self.input_3D.output), tf.squeeze(self.points))
    ...
    def train_ae(self, n_epochs=170):
